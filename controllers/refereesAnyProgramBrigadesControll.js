...
class RefereesAnyProgramBrigadesControll {
  ...
  async updateReferee(req, res) {
    ...
    const refereeResult = await RefereesAnyProgramBrigades.findOne({
      where: {
...
module.exports = new RefereesAnyProgramBrigadesControll();
